...
from ikol.utils.pose_utils import pixel2cam, reconstruction_error
from ikol.utils.presets import SimpleTransform3DSMPL_mmloader
import cv2

class PW3D_mmloader(data.Dataset):
    """ 3DPW dataset.
    ...
    def __init__(self,
        ...
        self.transformation = SimpleTransform3DSMPL_mmloader(
    ...
    def _lazy_load_json(self):
        ...
        # db_l2l = COCO('../HybrIK_dataset/pw3d/json/3DPW_test_l2l.json')
        # ann1 = db.anns[32664]
        # ann1_l2l = db_l2l.anns[32664]
        # with open(self._ann_file, 'r') as f:
        #     dataset_hybrik = json.load(f)
        # with open('../HybrIK_dataset/pw3d/json/3DPW_test_l2l.json', 'r') as f:
        #     dataset_l2l = json.load(f)
