...
from ikol.core.conventions.keypoints_mapping import get_mapping
from ikol.core.evaluation import (
    keypoint_3d_auc,
    keypoint_3d_pck,
    keypoint_mpjpe,
    vertice_pve,
)
from ikol.datasets.data_structures.human_data import HumanData
from ikol.models.body_models.builder import build_body_model
...
class HybrIKHumanImageDataset(BaseDataset, metaclass=ABCMeta):
    ...
    def load_annotations(self):
        ...
        try:
            ...
            self.intrinsic[:, 0, 0] = self.height
            self.intrinsic[:, 1, 1] = self.width
            self.intrinsic[:, 0, 2] = self.height/2
            self.intrinsic[:, 1, 2] = self.width/2
